        ...
        <div className="w-full flex flex-col gap-10 mx-auto ease-in duration-150">
            <div className="flex flex-col md:flex-row items-center justify-between">
                <div className="font-bold flex items-center gap-4 text-gray-800">
                    ...
                    <button onClick={handleClickFilter} className="w-full flex gap-2 duration-100 ease-in max-w-fit font-bold text-white hover:bg-orange-500 text-center bg-orange-400 px-5 py-2 rounded-full shadow-md">
                        <span>Filter</span>
                    </button>
                </div>
